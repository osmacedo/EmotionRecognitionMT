...
# Feature Extraction
model.add(Conv2D(32, (5, 5), padding='same', strides=1, activation='relu', input_shape=input_shape))
...
filename = 'model_train_kim_fer.csv'
csv_log = callbacks.CSVLogger(filename, separator=',', append=False)

# Export best weights
fp = "./tmp/kim_fer2013/Best-weights-my_model-{epoch:03d}-{val_acc:.4f}.hdf5"
...
plt.savefig(os.path.sep.join(["output", "conf_mtx_kim_fer.png"]))

# Save normalized confusion matrix
plot_confusion_matrix(y_trueskl, y_predskl, normalize=True)
plt.savefig(os.path.sep.join(["output", "conf_mtx_kim_fer_norm.png"]))
